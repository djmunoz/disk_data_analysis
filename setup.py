...
setup(
    ...
    packages=['disk_data_analysis','disk_data_analysis.circumbinary','disk_voronoi','disk_data_analysis.orbital','disk_data_analysis.plotting','disk_data_analysis.disk_hdf5'],
